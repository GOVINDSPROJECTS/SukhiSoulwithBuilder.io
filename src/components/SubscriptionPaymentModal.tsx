    ...
    <>
        ...
        <View style={styles.planBox}>
          {loading ? (
            ...
            <>
              {plans.length > 0 ? (
                <>
                  <Text style={styles.planTitle}>Select Plan Duration</Text>
                  <Picker
      ...
      >
        ...
        <View style={styles.centerSelf}>
          <Text style={[styles.coachModalTitle, styles.w40]}>
            Payment Received
          </Text>
          ...
          <Text style={[styles.text18, { width: wp(75), marginTop: hp(10) }]}>
            We’ve received your payment, and now you can use all the premium
            features.
          </Text>
          <Text
